...
import (
	"financo/internal/adapters_old/primary/web/api/app/accounts"
	"financo/internal/adapters_old/primary/web/api/app/applets"
	"financo/internal/adapters_old/primary/web/api/app/authentication"
	"financo/internal/adapters_old/primary/web/api/app/savingsgoals"
